...
define("mot_cle","关键字");
define("chercher","搜索");
define("modifier_horaire","修改时间");
define("horaire_midi_ou_soir","菜品划分时间（中午或晚上）");
define("Horaire_actuel","目前时间: ");
define("Horaire_desire","期望时间: ");
define("alert_valeur_horaire","时间不应为空值!!!");
