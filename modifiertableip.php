...
<head>
	...
	function check_pad()
	{
	  ...
	  var alert1= "<? print alert_adresse_padip; ?>";
	  var alert2= "<? print alert_format_padip; ?>";
	  var alert3= "<? print alert_table_number; ?>";
	  
	  
	  var padip = document.getElementById('adresseip').value;
	  var re = /^([0-9]|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.([0-9]|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.([0-9]|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.([0-9]|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])$/;  
	  
	  if (formpad.adresse_ip.value=="") { 
		alert(alert1);
		formpad.adresse_ip.focus();		
			return (false);
		}
		else if(!re.test(padip)){   
		     alert(alert2);
		     return (false);  
	   } 
		else if (formpad.table_number.value=="") {
		alert(alert3);
		formpad.table_number.focus();		
			return (false);
		}
		else
			return true;
					...
					<!-- box -->
						<div class="box" style="min-height:380px;" >
							...
							<center style="margin: 30">      		   		      
							   <h2 style="margin-left:300px; margin-top:10px; margin-bottom:10px; margin-right:400px; width: 150px;"> 
							   <a href="ajouertableip.php" target="_self" onMouseOver="mouseover(this)" onMouseOut="mouseout(this)" style="color:#2868f9;"> <img src="images/add.png" width="16" height="16" border="0"> <? print ajout_table_ip ?> </a> </h2>
										  
								<form name="formpad" method="post" action="modifieripnumber.php" onSubmit="return check_pad();">
								   <?print adresse_ip; ?> : <input type="text" name="adresse_ip" id="adresseip" value="<? print $ipadress; ?>">			 
								...
								<table width="80%" border="1" cellspacing="0" cellpadding="0" style="margin-top:10px; width: 600px;">
