						...
						<div class="box" style="min-height:380px;" >
							...
							<center style="margin: 30">      		   		      
							   ...
							   <a href="ajouertableip.php" target="_self" onMouseOver="mouseover(this)" onMouseOut="mouseout(this)" style="color:#2868f9;"> <img src="images/add.png" width="16" height="16" border="0"> <? print ajout_table_ip ?> </a> </h2>
								...
								<form method="post" action="relger_ip.php?action=confirm_modif_table_ip&ipadress=<?php print $ipadress;?>">
								   <?print adresse_ip; ?> :  <input type="text" name="adresse_ip" value="<? print $ipadress; ?>">			 
								   <?print table_Number; ?> : <input type="text" name="table_number"> 
								   <input type="submit" name="action" class="submitcss" id="action" value="<? echo confirm_modif_table_ip ?>" style="width:120px;">
