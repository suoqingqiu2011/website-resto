				...
				<div id="navigation">	
					<ul id="navi" >
						...
						<li><a href="#" style="color:#000; "><span><? print m_passe; ?></span></a>
							<ul>
								<li><a href="../modifypassword.php" style="font-size:2px;"><span><? print m_admin_gestion; ?></span></a></li>
						...
						<li id="switch_lang"><a href="#" style="color:#000; font-size:12px; width:160px;"><? print language; ?><? if($_SESSION['lang']=="fr") { ?> <img src="../images/fr.jpg"> <? } ?>  <? if($_SESSION['lang']=="cn") { ?> <img src="../images/cn.jpg"> <? } ?></a>
								<ul>		
									<li id="listeLang" style="height:40px; width:160px;">
										...
										?>
										<a href="../../lang/switchLang.php?newLang=<? echo $tab_lang[0]; ?>" style="color:#fff; font-size:2px; width:160px;"><? if($tab_lang[0]=="fr"){ echo "LANGAGE:français";} if($tab_lang[0]=="cn"){ echo "语言：中文";} ?>&nbsp;&nbsp;<img src="../images/<? echo $tab_lang[0]; ?>.jpg"> </a>
									</li>				
										<?  }
										  }
										} 
...
<div class="left_nav" >
		...
		<dd><a href="javascript:" class="nav_left" style="font-size:10;"><? print m_commande; ?></a>
			...
			<a href="c_index.php" style="width:230px; font-size:10; "><? print m_article_compte; ?></a>
			</div>
		</dd>
